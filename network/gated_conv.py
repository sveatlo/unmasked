...
class TransposeGatedConv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride = 1, padding = 0, dilation = 1, padding_type = "zero", activation = "lrelu", norm = "none", sn = True, scale_factor = 2):
